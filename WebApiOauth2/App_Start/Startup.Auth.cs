    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                Provider = new AppOAuthProvider(PublicClientId),//You need to implement this class (which I have in this tutorial) where you will verify the user credential and create identity claims in order to return the generated access token.
